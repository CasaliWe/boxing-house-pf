...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-3 pb-4 border-b border-gray-800">
        <div>
            <h1 class="text-xl md:text-2xl font-bold text-white">Olá, {{ auth()->user()->name }}</h1>
            <p class="text-xs md:text-sm text-gray-400 mt-1">Bem-vindo de volta ao seu portal de treinamento</p>
        </div>
