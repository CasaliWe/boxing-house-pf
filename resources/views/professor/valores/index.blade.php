...
<div class="space-y-8">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div class="w-full sm:w-auto">
            <h1 class="text-2xl md:text-3xl font-bold text-blue-400">💰 Valores</h1>
            <p class="text-gray-400 text-sm md:text-base">Cadastre os valores por quantidade de treinos semanais.</p>
        </div>
        <a href="{{ route('professor.valores.create') }}" class="bg-gradient-blue text-white px-5 py-3 rounded-lg font-medium hover:opacity-95 transition w-full sm:w-auto text-center">+ Novo Valor</a>
    </div>
