...
<aside class="w-72 bg-gradient-sidebar border-r border-gray-700 transition-transform duration-300 ease-in-out -translate-x-full md:translate-x-0 fixed md:static h-screen z-50 flex flex-col" id="sidebar">
    ...
    <nav class="py-6 flex-1 overflow-y-auto">
        @if(auth()->user()->role === 'professor')
            ...
            <div class="px-4 mb-2">
                <a href="{{ route('professor.ideias-exercicios.index') }}" class="flex items-center px-6 py-4 text-gray-300 hover:text-white rounded-lg transition-all duration-300 nav-hover {{ request()->routeIs('professor.ideias-exercicios.*') ? 'bg-gradient-blue text-white' : 'hover:bg-gradient-blue' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-4 mb-2">
                <a href="{{ route('professor.aulas-exp.index') }}" class="flex items-center px-6 py-4 text-gray-300 hover:text-white rounded-lg transition-all duration-300 nav-hover {{ request()->routeIs('professor.aulas-exp.*') ? 'bg-gradient-blue text-white' : 'hover:bg-gradient-blue' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
